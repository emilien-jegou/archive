...
![Dashboard of viabird](https://github.com/emilien-jegou/archive/blob/master/viabird/screenshots/dashboard.png?raw=true)
...
Une fois installé la mangeoire offre aux utilisateurs une page web sur laquelle ils peuvent visionner les photos des oiseaux venant se déposer à l'intérieur de celle-ci.
...
Les nouvelles installation du logiciel peuvent utiliser la branche new_box.
...
Une fois installé viabird se mettra à jour automatiquement si une connexion internet est disponible et se lancera automatiquement au démarrage.
